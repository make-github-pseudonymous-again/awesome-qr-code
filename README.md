...
- [toolkitlabs-qr](https://github.com/YtinuMoc/toolkitlabs-qr) - Browser PNG/SVG generator (no account, no tracking) with [live demo](https://cdn.jsdelivr.net/npm/toolkitlabs-qr@latest/index.html) and optional batch CLI from CSV.

...
- [QRKit](https://qrkit.davrapps.dev) - Free browser-based QR code generator. Create QR codes for URLs, text, WiFi, email, vCard, and more. No signup required, runs fully client-side.
